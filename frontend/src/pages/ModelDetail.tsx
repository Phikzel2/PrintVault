  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col lg:flex-row gap-6 lg:items-start">
        {/* 3D Viewer — sticky so it stays in view while sidebar scrolls */}
        <div className="lg:flex-1 card overflow-hidden min-h-[320px] lg:sticky lg:top-[5.5rem] lg:h-[calc(100vh-7rem)]">
          <ModelViewer files={model.files} />
        </div>

        {/* Metadata panel — natural height, page scrolls */}
